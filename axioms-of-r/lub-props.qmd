...
In fact, from this, [one can prove that $a_i\leq b_j$ for any $i,j\in\N.$]{.explain color="yellow" note="Here's the proof. If $i\leq j,$ then we have $a_i\leq a_{i+1}\leq\cdots\leq a_j\leq b_j,$ and if $i\geq j,$ we have $a_i\leq b_i\leq b_{i-1}\leq \cdots\leq b_j.$"}
